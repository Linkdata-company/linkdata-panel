...
- Add support for Dovecote Sieve #2163 (@gejobj) => [How to enable Managesieve](https://linkdata.com/docs/server-administration/email.html#how-can-i-enable-managesieve)
