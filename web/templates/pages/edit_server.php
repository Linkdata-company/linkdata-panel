						...
						<?php if ($v_mysql == "yes") { ?>
							...
							<div class="u-mb10">
								<label for="v_phpmyadmin_key" class="form-label">
									...
									<span class="hint">
										<a
											href="https://linkdata.com/docs/server-administration/databases.html"
											target="_blank"
										>
											(<?= _("More info") ?>)
										</a>
				...
				<div class="box-collapse-content">
					...
					<div class="u-mb10">
						<label for="v_backup_mode" class="form-label">
							<?= _("Compression") ?>
							<a
								href="https://linkdata.com/docs/server-administration/backup-restore.html#what-is-the-difference-between-zstd-and-gzip"
								target="_blank"
								class="u-ml5"
							>
					...
					<div class="u-mb10">
						<label for="v_backup_gzip" class="form-label">
							<?= _("Compression Level") ?>
							<a
								href="https://linkdata.com/docs/server-administration/backup-restore.html#what-is-the-optimal-compression-ratio"
								target="_blank"
								class="u-ml5"
							>
								<i class="fas fa-circle-question"></i>
					...
					<div class="u-mb20">
						<label for="v_backup_dir" class="form-label">
							<?= _("Directory") ?>
							<a
								href="https://linkdata.com/docs/server-administration/backup-restore.html#how-to-change-default-backup-folder"
								target="_blank"
								class="u-ml5"
							>
								<i class="fas fa-circle-question"></i>
					...
					<div x-cloak x-show="remoteBackupEnabled" class="u-pl30 u-mt20">
						<div class="u-mb10">
							<label for="backup_type" class="form-label">
								<?= _("Protocol") ?>
								<a
									href="https://linkdata.com/docs/server-administration/backup-restore.html#what-kind-of-protocols-are-currently-supported"
									target="_blank"
									class="u-ml5"
								>
									<i class="fas fa-circle-question"></i>
